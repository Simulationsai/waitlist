  ...
  return (
    <div className="page">
      <div className="container">
        <div className="page-head" id="vision">
          ...
          <p className="p">
            ...
            optimization modeling, environment testing, and AI system validation. Participation in
            distributed infrastructure is often fragmented, hard to evaluate, or misaligned with
        ...
        <div className="grid cols-2" style={{ marginTop: 18 }}>
          <div className="card">
            <div className="card-inner">
              ...
              <p className="p">
                SimulationsAI is designed to coordinate distributed compute and simulation capacity
                through measurable contribution and progressive access. Contributors can:
              </p>
              <ul className="list">
              ...
              <div style={{ height: 12 }} />
              <p className="p">
                The intent is to make participation easier to understand and easier to evaluate by
                using clear contribution methods, reliability measurements, and phased access rules.
              </p>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-inner">
              ...
              <p className="p">
                SimulationsAI prioritizes long-term sustainability over short-term growth. Where
                appropriate, mechanisms are designed with operational safety in mind, including
        ...
        <div className="card anchor" style={{ marginTop: 16 }}>
          <div className="card-inner">
